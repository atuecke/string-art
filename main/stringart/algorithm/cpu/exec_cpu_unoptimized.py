...
def create_string_art_cpu_unoptimized(first_anchor: int, base_img: BaseImage, string_art_img: StringArtImage, line_pixel_dict: dict, line_darkness_dict: dict, iterations: int, cost_method: CostMethod = CostMethod.MEAN, max_darkness: float = None, eval_interval: int = None, importance_map: ImportanceMap = None, use_prev_anchor: bool = True, random_neighbor = False):
    """
    ...
    #for iter in range(iterations):
        ...
        string_art_img.cost_list.append((best_loss, iter))
